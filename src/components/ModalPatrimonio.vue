...
<script>
export default {
  name: "ModalPatrimonio",
  methods: {
    closeModal: function () {
      document.querySelector(".patrimonio-modal").classList.add("d-none");
      document.querySelector(".patrimonio-modal").classList.remove("d-flex");
    },
  },
};
</script>
...
.patrimonio-modal .modal-container {
  height: 70vh;
  max-width: 700px;
